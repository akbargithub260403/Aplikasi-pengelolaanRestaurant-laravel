          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header ">
                ...
                <h2 class="d-inline"><i>Daftar Paket Menu</i></h2>
              </div>
              @if (session('status'))
                    ...
                    <div class="card card-stats">
                      <div class="card-body ">
                        <div class="row">
                          ...
                          <div class="col-10 col-md-11">
                            <div class="numbers">
                              <center><p class="card-category my-2" style="margin-left:20px;">{{$dt->nama_paket}}</p></center>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="card-footer ">
                        ...
                        <div class="stats">
                          ...
                          <a href="/detail/paketMenu/{{$dt->id}}" style="text-decoration:none;">Order Now</a>
                        </div>
                      </div>
                    </div>
                  </div>
