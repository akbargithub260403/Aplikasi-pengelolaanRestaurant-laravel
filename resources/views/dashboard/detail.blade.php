...
<div class="content">
            ...
            <div class="card card-user">
              ...
              <div class="card-body">
                <div class="author">
                  <a href="#">
                    ...
                    <h5 class="title">{{$dt->nama_menu}}</h5>
                  </a>
                </div>
              ...
              <div class="card-footer">
                ...
                <div class="button-container">
                  <div class="row">
                    <div class="col">
                      <center><h5><small>Rp.{{$dt->harga}}</small></center>
                    </div>
                  </div>
                </div>
              @if(auth()->user()->role == 'Administrator')
                ...
                <div class="button-container">
                  <div class="row">
                    <div class="col">
                        <a href="/update/menu/{{$dt->id}}" class="btn btn-outline-warning">Update</a>
                    </div>
                    <div class="col">
                      <form action="/delete/menu/{{$dt->id}}" method="post">
                      @csrf
                      @method('delete')
        ...
        @endif
            <div class="card card-user">
              ...
              <div class="card-body">
                <form action="/add/Order/dibuat" method="POST">
                @csrf
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        <label>Nama Menu</label>
                        <input type="text" name="nama_pesanan" class="form-control @error('nama_menu') is-invalid @enderror" readonly placeholder="Company" value="{{$dt->nama_menu}}">
                        @error('nama_menu')
